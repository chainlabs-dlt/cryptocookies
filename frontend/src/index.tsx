...
export type ChainlabsAddresses = {
  CKI: string;
  FDG: string;
  CkiDistr: string;
  FdgDistr: string;
...
export const  Addresses : ChainlabsAddresses = {
  ...
  CCStakingCKI: "0x0a58c62697958311c82F6CA5645fb72aeBCD8522",
  CCStakingFDG: "0x38122594740D9BFfde1a577Fb0692a52bF0d5F40"
};
